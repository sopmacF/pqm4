...
* Returns 0 (success)
**************************************************/
static int kyber_kem_keypair_derand(uint8_t *pk,
        uint8_t *sk,
        const uint8_t *coins) {
...
int kyber_kem_keypair(unsigned char *pk, unsigned char *sk) {
    ...
    kyber_kem_keypair_derand(pk, sk, coins);
    return 0;
}
...
* Returns 0 (success)
**************************************************/
static int kyber_kem_enc_derand(uint8_t *ct,
        uint8_t *ss,
        const uint8_t *pk,
        const uint8_t *coins) {
...
int kyber_kem_enc(uint8_t *ct,
    ...
    kyber_kem_enc_derand(ct, ss, pk, coins);
    return 0;
}
